 ...
 * @return {string} The destination from a subdomain, header, or request parameter.
 */
 ...
 *
 * @param {string} dest - A string representing the requested destination.
 * @return {Object} An object containing type, value, an modifier.
 */
